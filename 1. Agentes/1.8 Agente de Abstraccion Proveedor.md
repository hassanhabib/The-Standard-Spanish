# 1.8 Bibliotecas de Abstracción de Proveedores Estandarizados (SPAL)
...
El Estándard manda confiar sobre proveedores estandarizados para el diseño de sistemas y desarrollo. Estos proveedores estandarizados debe tener las siguientes características:
