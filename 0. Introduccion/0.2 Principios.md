...
componentes base locales crean un nivel de enredo vertical que perjudica la 
mantenibilidad y legibilidad del código.
Los enredos verticales son tan perjudiciales 
como la creación de puntos únicos de fallo en 
cualquier sistema.

Los enredos (vertical u horizontal) también impiden que los ingenieros de 
...
Este principio favorece la duplicación sobre presumiblemente la simplificación a través del enredo del código.
